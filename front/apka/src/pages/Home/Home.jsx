    ...
    <>
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex mt-4">
          <button
            className="px-4 py-2 flex items-center justify-center bg-blue-100 hover:bg-blue-200 rounded-md text-blue-700 transition-colors duration-300 w-auto cursor-pointer"
        ...
        {isDateFiltered && (
          <div className="bg-blue-50 border border-blue-200 rounded-md p-3 mb-4 flex justify-between items-center">
            <p className="text-blue-700">
              Pokazuję notatki z dnia:{" "}
              {filteredNotes.length > 0
                ? new Date(filteredNotes[0].createdOn).toLocaleDateString(
                    "pl-PL",
        ...
        {displayNotes.length > 0 ? (
          ...
          <EmptyCard
            imgSrc={
              isSearch ? NoDataImg : isDateFiltered ? NoDataImg : AddNotesImg
            }
            message={
              isSearch
                ? "Brak takich notatek"
